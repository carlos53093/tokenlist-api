...
export default createTokenUtils([
  ...
  { key: 'sushi', type: 'token', symbol: 'SUSHI', name: 'Sushi Token', address: '0x0b3f868e0be5597d5db7feb59e1cadbb0fdda50a', decimals: 18, isStableCoin: false },
  { key: 'bal', type: 'token', symbol: 'BAL', name: 'balancer Token', address: '0x9a71012b13ca4d3d0cdc72a177df3ef03b0e76a3', decimals: 18, isStableCoin: false },
  { key: 'crv', type: 'token', symbol: 'CRV', name: 'CRV Token', address: '0x172370d5cd63279efa6d502dab29171933a610af', decimals: 18, isStableCoin: false },
  { key: 'dpi', type: 'token', symbol: 'DPI', name: 'DPI Token', address: '0x85955046df4668e1dd369d2de9f3aeb98dd2a369', decimals: 18, isStableCoin: false },
  { key: 'link', type: 'token', symbol: 'LINK', name: 'ChainLink Token', address: '0x53e0bca35ec356bd5dddfebbd1fc0fd03fabad39', decimals: 18, isStableCoin: false },
  { key: 'ghst', type: 'token', symbol: 'GHST', name: 'Aavegotchi GHST Token', address: '0x385Eeac5cB85A38A9a07A70c73e0a3271CfB54A7', decimals: 18, isStableCoin: false },
])  
